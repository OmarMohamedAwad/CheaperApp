...
public class PerviousAdviretesmentFragment extends Fragment implements CurrentAdsRecyclerviewaAdapter.RecyclerviewClickListenerInterface {
    ...
    public PerviousAdviretesmentFragment() {
